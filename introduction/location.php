    ...
    <main id="content" class="introduction">
        <div class="container">
            <section>
                ...
                <nav class="tab-menu">
                    <ul>
                        <li class="active"><a href="/introduction/location.php">서울 본사</a></li>
                        <li><a href="/introduction/location_chongju.php">충주 공장</a></li>
                    </ul>
                </nav>
                <div class="section-content">
                    <article class="location">
                        <div class="map">
                            <div id="daumRoughmapContainer1547621630361" class="root_daum_roughmap root_daum_roughmap_landing"></div>
                        </div>
                        <div class="details">
                            <div class="information">
                                <ul>
                                    <li><b>주소</b> <address>서울시 영등포구 신풍로 68 (신길동, 씨제이빌딩)</address>
                                    </li>
                                    <li><b>전화</b> 02-835-5700</li>
                                    <li><b>팩스</b> 070-4347-5398</li>
                                </ul>
                            </div>
                            <div class="btn-area">
                                <p>
